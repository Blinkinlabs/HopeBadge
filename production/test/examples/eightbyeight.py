...
class EightByEightTestRig():
    ...
    def checkForUsbBootloaderDevice(self):
        ...
        result = 1
        while (result != 0):
            result = subprocess.call(["lsusb", "-d", "8888:8888"])
    ...
    def checkForUsbDevice(self):
        ...
        while (result != 0):
            ...
            result = subprocess.call(["lsusb", "-d", "8888:8889"])
...
def testIcspGpio():
    # ICSP GPIO test: use logic analyzer to verify each output is exercised in
    # sequence
