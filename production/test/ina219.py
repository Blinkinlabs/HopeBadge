...
# ===========================================================================
    ...
    # 2 x 12-bit samples averaged together
    __INA219_CONFIG_BADCRES_12BIT_2S_1060US = 0x0480
    # 4 x 12-bit samples averaged together
    __INA219_CONFIG_BADCRES_12BIT_4S_2130US = 0x0500
    # 8 x 12-bit samples averaged together
    __INA219_CONFIG_BADCRES_12BIT_8S_4260US = 0x0580
    # 16 x 12-bit samples averaged together
    __INA219_CONFIG_BADCRES_12BIT_16S_8510US = 0x0600
    # 32 x 12-bit samples averaged together
    __INA219_CONFIG_BADCRES_12BIT_32S_17MS = 0x0680
    # 64 x 12-bit samples averaged together
    __INA219_CONFIG_BADCRES_12BIT_64S_34MS = 0x0700
    # 128 x 12-bit samples averaged together
    __INA219_CONFIG_BADCRES_12BIT_128S_69MS = 0x0780
    ...
    __INA219_CONFIG_SADCRES_12BIT_2S_1060US = 0x0048
    # 4 x 12-bit shunt samples averaged together
    __INA219_CONFIG_SADCRES_12BIT_4S_2130US = 0x0050
    # 8 x 12-bit shunt samples averaged together
    __INA219_CONFIG_SADCRES_12BIT_8S_4260US = 0x0058
    # 16 x 12-bit shunt samples averaged together
    __INA219_CONFIG_SADCRES_12BIT_16S_8510US = 0x0060
    # 32 x 12-bit shunt samples averaged together
    __INA219_CONFIG_SADCRES_12BIT_32S_17MS = 0x0068
    # 64 x 12-bit shunt samples averaged together
    __INA219_CONFIG_SADCRES_12BIT_64S_34MS = 0x0070
    # 128 x 12-bit shunt samples averaged together
    __INA219_CONFIG_SADCRES_12BIT_128S_69MS = 0x0078
...
# ===========================================================================
    ...
    def measure(self):
        ...
        while(True):
            time.sleep(.05)
            result = self._device.readU16(
                self.__INA219_REG_BUSVOLTAGE, little_endian=False)
