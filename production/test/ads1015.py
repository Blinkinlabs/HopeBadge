...
# ===========================================================================
    ...
    # Traditional comparitor with hysteresis
    __ADS1015_CONFIG_COMP_MODE_TRADITIONAL = 0x0010
    ...
    def measure(self, channel):
        ...
        while(True):
            result = self._device.readU16(
                self.__ADS1015_REG_CONFIG, little_endian=False)
